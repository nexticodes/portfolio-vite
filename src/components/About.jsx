  ...
  return (
    <div className='container about'>
        ...
        <div className='container-content'>
            ...
            <p>I am innately interested in engineering, physics, technology, and gaming. When I am not building and tutoring, I make sure I'm occupied by learning and exploring blockchain technologies, including Web 3.</p>
